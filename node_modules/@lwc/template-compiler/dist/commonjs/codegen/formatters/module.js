...
function moduleNameToImport(name) {
    ...
    return t.importDeclaration([t.importDefaultSpecifier(localIdentifier)], t.literal(helpers_1.kebabcaseToCamelcase(name)));
}
function generateSecureImports(additionalImports) {
    ...
    return t.importDeclaration([
        ...
        ...imports,
    ], t.literal(constants_1.LWC_MODULE_NAME));
}
